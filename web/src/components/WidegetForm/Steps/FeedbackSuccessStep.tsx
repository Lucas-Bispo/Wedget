...
export function FeedbackSuccessStep( { onFeedbackRestartRequested}: FeedbackSuccessStepProps){
    return(
        ...
        <div className="flex flex-col itemn-center py-10 w-[304px]">
            ...
            className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 houver:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
